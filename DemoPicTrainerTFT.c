...
// Declaración de funciones de interfaz TFT
...
void mostrarInicio(void)
{
    ...
    print("Presiona para continuar", CENTER, 100, 0);
}
...
void mostrarEstado(int peso)
{
    ...
    setColor(VGA_WHITE);
    char buf[32];
    sprintf(buf, "Comida restante: %d%%", peso);
    print(buf, LEFT, 40, 0);
    print("Ultima vez: 10:42", LEFT, 60, 0); // reemplazar con hora real si se desea
